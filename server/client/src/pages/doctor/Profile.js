...
const Profile = () => {
  ...
  const onFinish = async (values) => {
    try {
      ...
      const response = await axios.post(`${window.location.origin}/api/doctor/updateProfile`, {
  ...
  const getDoctorInfo = async () => {
    try {
      const res = await axios.post(`${window.location.origin}/api/doctor/getDoctorInfo`, { userId: params.id }, {
