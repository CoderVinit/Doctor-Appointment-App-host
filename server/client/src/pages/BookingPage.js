...
const BookingPage = () => {
  ...
  const getData = async () => {
    try {
      ...
      const response = await axios.post(`${window.location.origin}/api/doctor/getDoctorById`, { doctorId: params.doctorId }, {
        headers: {
  ...
  const handleBooking = async () => {
    try {
      ...
      dispatch(showLoading())
      const res = await axios.post(`${window.location.origin}/api/user/book-appointment`,
  ...
  const handleAvailability = async () => {
    try {
      dispatch(showLoading())
      const res = await axios.post(`${window.location.origin}/api/user/booking-availability`,
